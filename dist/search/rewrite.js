 ...
 */
const GREETING_PATTERN = /\b(hi|hello|hey|greetings|good\s+(?:morning|afternoon|evening))\b[,!.\s]*/gi;
const HEDGING_PATTERN = /\b(can you|could you|would you|will you|i was wondering if|i was wondering|would you mind|do you think you could|i need you to|i want you to|i'd like you to|help me with|help me|tell me about|tell me|show me|explain to me|i have a question about|quick question)\b\s*/gi;
...
const TECHNICAL_TERM_PATTERN = /\b[a-zA-Z0-9]+[._-][a-zA-Z0-9]+(?:[._-][a-zA-Z0-9]+)*\b|\b[a-z]+[A-Z][a-zA-Z]*\b/g;
 ...
 */
export function rewriteQuery(message) {
    if (message.trim().length < MIN_QUERY_LENGTH)
        return null;
