...
export function registerTagsTools(server) {
    server.tool("obsidian_tags", "List tags in the vault or get info about a specific tag", {
        action: z
            .enum(["list", "get"])
    ...
    }, { readOnlyHint: true }, async ({ action, name, file, path, total, counts, sort, verbose, format }) => {
