...
export function registerSearchTools(server) {
    server.tool("obsidian_search", "Search the vault for text. Use context=true to include matching line context. For deeper context on a topic, use obsidian_session(action='seed', query=...) which searches and then follows graph links from the result.", {
    ...
    }, { readOnlyHint: true }, async ({ query, context, path, limit, case_sensitive, total, format }) => {
